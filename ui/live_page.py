...
class LivePage(QWidget):
    ...
    def __init__(self, settings: AudioSettings, parent: QWidget | None = None,
        ...
        grid.addWidget(self.format_label, 5, 0, 1, 3)
        self.retry_button = QPushButton("今すぐ再接続")
        self.retry_button.hide()
        grid.addWidget(self.retry_button, 5, 3)
        ...
        self.readiness_label = QLabel("Oracleサンプルを確認しています。")
    ...
    def _update_controls(self) -> None:
        ...
        self.retry_button.setVisible(self._state in {"DEVICE_LOST", "RECONNECTING"})
        self.retry_button.setEnabled(self._state in {"DEVICE_LOST", "RECONNECTING"})
        self.dashboard.auto_checkbox.setEnabled(idle)
